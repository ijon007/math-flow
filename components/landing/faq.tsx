...
export function FAQSection() {
  return (
    <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent" id="faq">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-16 text-center">
          <h1 className="mb-3 text-center text-4xl lg:text-5xl">
            Frequently asked questions
          </h1>
          <p>
            Everything you need to know about Math Flow. Can&apos;t find what
            you&apos;re looking for?
          </p>
        </div>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            {faqs.map((faq, index) => (
              <AccordionItem
                className="border-zinc-200 border-b last:border-b-0"
                key={index}
                value={`item-${index}`}
              >
                <AccordionTrigger className="cursor-pointer py-6 text-left font-medium text-black text-lg hover:text-neutral-700">
                  {faq.question}
                </AccordionTrigger>
